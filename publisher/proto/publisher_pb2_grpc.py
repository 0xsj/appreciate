...
class PublisherStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateFeed = channel.unary_unary(
                '/Publisher/CreateFeed',
                request_serializer=publisher__pb2.CreateFeedRequest.SerializeToString,
                response_deserializer=publisher__pb2.CreateFeedResponse.FromString,
...
def add_PublisherServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CreateFeed': grpc.unary_unary_rpc_method_handler(
                    servicer.CreateFeed,
                    request_deserializer=publisher__pb2.CreateFeedRequest.FromString,
                    response_serializer=publisher__pb2.CreateFeedResponse.SerializeToString,
            ),
    }
...
class Publisher(object):
    ...
    def CreateFeed(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Publisher/CreateFeed',
            publisher__pb2.CreateFeedRequest.SerializeToString,
            publisher__pb2.CreateFeedResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
